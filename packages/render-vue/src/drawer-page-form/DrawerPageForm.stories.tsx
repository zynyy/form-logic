...
const meta: Meta<typeof DrawerPageForm> = {
...
export default meta;
type Story = StoryObj<typeof DrawerPageForm>;

let formConfig;

requestGet('local-api/model-page/detail', { pageCode: 'ModelPage_Data_C' }).then((res) => {
  const { data } = res;
