import { batch, Tracker } from '@formily/reactive';
import Vue from 'vue';
...
export const observer = (Component: any, observerOptions?: ObserverOptions): any => {
  const name =
  ...
  ExtendedComponent.prototype.$mount = function (this: any, ...args: any[]) {
    ...
    const tracker: Tracker = new Tracker(() => {
      ...
      if (observerOptions?.scheduler && typeof observerOptions.scheduler === 'function') {
