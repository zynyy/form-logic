import { onFieldInit, onFieldInputValueChange, useCreateForm } from '@formlogic/render-core-vue2';
...
export default {
   ...
   */
  title: 'SchemeButtonsForm',
  component: SchemeButtonsForm,
  argTypes: {
    config: {
...
const render = ({ metaSchema, pattern, hasGroup }) => ({
  ...
  setup() {
    ...
    return () => {
      ...
      return <SchemeButtonsForm form={form.value} schema={schema} />;
    };
  },
});
