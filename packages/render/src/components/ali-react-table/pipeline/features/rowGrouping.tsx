...
import { CaretRightIcon } from '@/components/ali-react-table/component/icon';

import InlineFlexCell from '@/components/ali-react-table/component/inline-flex-cell';
import { safeRender, safeRenderHeader } from '@/components/ali-react-table/utils/safe';
  ...
  return (pipeline: TablePipeline) => {
    ...
    function processColumns(columns: ArtColumn[]) {
      ...
      const render = (value: any, row: any, rowIndex: number) => {
        ...
        return (
          <InlineFlexCell className={cx('expansion-cell', expandCls)}>
            <CaretRightIcon
