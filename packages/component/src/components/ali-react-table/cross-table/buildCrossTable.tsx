...
import { ArtTableProps } from '../art-table';
...
import { ArtColumn, SpanRect } from '@/components/ali-react-table/interfaces';
import { always, getTreeDepth, isLeafNode } from '@/components/ali-react-table/utils';

import { ROW_KEY } from '@/components/ali-react-table/utils';
...
export interface BuildCrossTableReturn extends Pick<ArtTableProps, 'columns' | 'dataSource'> {}

const buildCrossTable = (
  options: BuildCrossTableOptions & {
    columnOffset?: number;
    rowOffset?: number;
  },
): BuildCrossTableReturn => {
  ...
  function getColumns(): CrossTableRenderColumn[] {
    ...
    function getDataPartColumns() {
      ...
      function dfs(
        ...
        ctx: Ctx,
      ): (CrossTableDataColumn | CrossTableDataParentColumn)[] {
...
export default buildCrossTable;
