import type { IEngineContext } from '@/interface';
import { isFn, KeyCode } from '@/utils';
...
export class Shortcut {
  codes: KeyCode[][];
  handler: ((context: IEngineContext) => void) | undefined;
  matcher: ((codes: KeyCode[]) => boolean) | undefined;
