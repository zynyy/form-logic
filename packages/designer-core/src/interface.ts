...
export type IResizable = {
  width?: boolean;
  height?: boolean;
  callback?: (node: TreeNode, element: Element, rect: IRect) => void;
};

export type ITranslate = {
  x?: boolean;
  y?: boolean;
  callback?: (node: TreeNode, element: Element, point: IPoint) => void;
};
...
export interface IDesignerProps {
  ...
  settingFormEffects?: (target: TreeNode, form: Form) => void;
  aliasComponentName?: string; // 组件别名给切换组件使用的
  [key: string]: any;
}
